...
export default function CalificarTPPage() {
  ...
  if (isLoading || loadingEntrega || !user || user.role !== "teacher" && user.role !== "profesor") {
    return (
    ...
    return (
      <DashboardLayout>
        <div className="text-center py-12">
          <p className="text-lg font-medium">{error || "Trabajo no encontrado"}</p>
        </div>
      </DashboardLayout>
    )
  }
    ...
    <DashboardLayout>
      <div className="space-y-6 max-w-3xl">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Calificar Trabajo Práctico</h1>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">{entrega.Tp?.Comision?.Materia?.nombre || entrega.Tp?.Comision?.nombre}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="p-4 bg-muted rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">{entrega.Tp?.consigna}</p>
            </div>
          </CardContent>
        </Card>

...
export default function EditTPPage() {
      ...
      tpAPI.getById(tpId)
        .then((response) => {
          ...
          setFormData({
            ...
            fecha_entrega: tpData.fecha_entrega ? tpData.fecha_entrega.split('T')[0] : "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: error.message || "No se pudo actualizar el trabajo práctico",
        variant: "destructive"
      })
    } finally {
      setSubmitting(false)
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setFormData({ ...formData, consigna: e.target.value })}
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="vigente" className="font-normal cursor-pointer">
